...
;#CHANGE done
;#MPN DATA
; #NOTE - GO HOVER OVER LEFT MOST SIDE OF MPN AREA INSTEAD OF THE RIGHT MOST
;#REF COORDS
;862, 385, 0
  MouseMove, startx+573, starty, 0
  Sleep 200
  Click 2
  Sleep 350
  Send ^c
...
;#CHANGE done
;#PRICE DATA
; #NOTE - GO HOVER OVER LEFT MOST SIDE OF PRICE AREA INSTEAD OF THE RIGHT MOST
;#REF COORDS
;1084, 283, 0
  MouseMove, startx+795, starty, 0
  Sleep 200
  Click 2
  Sleep 350
  Send ^c
...
;#CHANGE done
;#UPC / ASIN DATA
; #NOTE - GO HOVER OVER LEFT MOST SIDE OF UPC / ASIN AREA INSTEAD OF THE RIGHT MOST
;#REF COORDS
;1160, 285, 0
  MouseMove, startx+871, starty, 0
   Sleep 200
   Click 2
   Sleep 350
   Send ^c
...
;new stuff for generation
 ...
 ;NEW PRICING RULES
    ...
    if (!apbool && !epbool && !ambool && (instr checks)){
      tagswapcheck := 1
    }
